      ...
      >
        <ul className="navbar-nav">
          <li className="nav-item">
            <Link className="nav-link active" to={'/advisor'}>
              Dashboard
            </Link>
          </li>
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="navbarDropdown">
              <Link className="dropdown-item" to={'/advisor/addProperty'}>
                Add Property
              </Link>
              <Link className="dropdown-item" to={'/advisor/manageProperty'}>
                Manage Property
              </Link>
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <Link className="dropdown-item" to={'/advisor/addmessages'}>
                Add Enquiry
              </Link>
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <Link className="dropdown-item" to={'/advisor/manageBooking'}>
                Manage Pending Booking
              </Link>

              <Link className="dropdown-item" to={'/advisor/manageApprovedBooking'}>
                Manage Approved Booking
              </Link>

              <Link className="dropdown-item" to={'/advisor/manageRejectedBooking'}>
          ...
          <li className="nav-item">
            <Link className="nav-link" to={'/advisor/profile'}>
            Profile
            </Link>
          </li>
