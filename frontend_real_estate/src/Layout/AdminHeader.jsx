        ...
        <ul className="navbar-nav">
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <Link className="dropdown-item" to={'/admin/manageCategory'}>
                Manage Catgeory
              </Link>
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="navbarDropdown">
              <Link className="dropdown-item" to={'/admin/verifyProperty'}>
                Verify Properties
              </Link>
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="navbarDropdown">
              <Link className="dropdown-item" to={'/admin/managecustomers'}>
                Manage Customers
              </Link>
              <Link className="dropdown-item" to={'/admin/manageadvisor'}>
                Manage Advisors
              </Link>
              
            <Link className="dropdown-item" to={'/admin/viewQuery'}>Manage Enquiry
            </Link>
